/*
  ...
  "Autonomous drones are used in agriculture for monitoring crops and spraying.",
  "Facial recognition systems raise concerns about privacy and surveillance."

"AI tools like NLP and facial recognition impact our daily lives.";
...
const userInput = "AI tools like NLP and facial recognition impact our daily lives.";
...
// işlenmiş metinler
const processedDocuments = documents.map(textProcess)
const processedInput = textProcess(userInput);


processedDocuments.map(e=>tfidf.addDocument(e));
...
// Kullanıcı vektörü
const inputVector = getTfIdfVector(processedDocuments.length); // son index
