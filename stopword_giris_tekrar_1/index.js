/*
This is a simple example to demonstrate how stopwords can be removed.

metnini tokenize edip dsah sonra da stopword kısmını ayarlayalım
...
const textEng = "This is a simple example to demonstrate how stopwords can be removed.";
...
(async () => {
    ...
    const stopWordTokens = docEng.tokens().filter(token => !stopwords.has(token.out().toLowerCase())).out()
    console.log("--- Stop WOrd Out ---")
