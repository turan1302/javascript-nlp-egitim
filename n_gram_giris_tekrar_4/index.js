...
5G technology enables faster data transmission and low-latency communication.
Wearable devices track health metrics and improve fitness monitoring.
Smart cities use IoT sensors to manage traffic and energy efficiently.
Cryptocurrency adoption is growing in online marketplaces.
Biotechnology is revolutionizing agriculture with genetically modified crops.

IoT devices and 5G networks are transforming urban infrastructure.
...
const userInput = "IoT devices and 5G networks are transforming urban infrastructure";
...
function textProcess(text){
    ...
    const allGrams = [...filteredResult,bigrams];

    return allGrams.join(" ");
}
